...
public class DBConstants {
    ...
    public static final String GET_NB_TICKET = "select count(*) from ticket where VEHICLE_REG_NUMBER = ?";//Récupère le nombre de tickets en fonction de la plaque d'immatriculation
}
